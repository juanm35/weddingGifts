...
export const bankDetails = {
  accountHolder: "Sofia Noguer",
  cuit: "27-35972982-6",
  cvu: "0000003100000566495177",
  alias: "sofi.juan.pesos",
  reference: "Regalo de Boda - "
};

export const coupleInfo = {
  names: "Sofi & Juan",
  date: "28 de Febrero, 2026",
  message: "Estamos muy felices de compartir este momento especial con ustedes. Su presencia es el mejor regalo, pero si quieren contribuir a nuestra nueva vida juntos, acá hay algunas ideas que nos encantarían.",
  bannerImage: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200&h=600&fit=crop"
};
